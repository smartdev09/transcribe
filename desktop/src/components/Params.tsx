...
import AdvancedTranscribe from './AdvancedTranscribe'
...
export default function ModelOptions({ options, setOptions }: ParamsProps) {
	...
	return (
		...
		<div className='mb-5'>
			<div className='flex items-center justify-between label-text text-2xl font-bold mb-4 mt-2'>
			...
			<div className='w-full ml-2'>
				...
				<CollapsibleSection title={t('common.speaker-recognition')}>
				...
				<CollapsibleSection title={t('Summarize ✨')} >
					...
					<label className="form-control w-full mt-5">
						<button onClick={checkLlm} className="btn btn-primary btn-sm bg-purple-600 hover:bg-purple-700">
				...
				<CollapsibleSection title={t('common.model-options')}>
					<div className="form-control w-full mt-3">
						<label className="label cursor-pointer">
							<span className="label-text flex items-center gap-1 cursor-default">
				...
				<CollapsibleSection title={t('common.ffmpeg-options')}>
					<div className="form-control w-full mt-3">
						<label className="label cursor-pointer">
							<span className="label-text flex items-center gap-1 cursor-default">
